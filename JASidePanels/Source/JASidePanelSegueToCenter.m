...
- (void)perform {
    ...
    if (![dst isKindOfClass:navigationController] && ([sidePC.centerPanel isKindOfClass:navigationController] || [sidePC.centerPanel isKindOfClass:[WETRootViewController class]])) {
